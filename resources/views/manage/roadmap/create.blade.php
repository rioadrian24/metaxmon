@extends('layout.manage', ['title' => 'Create roadmaps'])
            ...
            <div class="card-body">
                ...
                <form action="{{ route('roadmaps.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col">
                            <textarea name="description" id="description" cols="4" class="form-control" placeholder="Enter description">{{ old('description') }}</textarea>
                        </div>
                    </div>
